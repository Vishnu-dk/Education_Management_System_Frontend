...
export default function StudentProfileFields() {
  ...
  const { data: user, isLoading, error } = useGetProfileQuery(userId);
  ...
  return (
    <Box>
      ...
      >
        ...
        <InfoCard label="Course" value={user.course} />
        <InfoCard label="Roll Number" value={user.rollNo} />

        <InfoCard label="Admission Number" value={user.admissionNo} />
